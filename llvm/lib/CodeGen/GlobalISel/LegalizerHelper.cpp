...
// Integer arithmetic libcalls (MUL, DIV, REM) support 8/16/32/64/128-bit sizes.
#define RTLIBCASE_INT_ARITH(LibcallPrefix)                                     \
  do {                                                                         \
    switch (Size) {                                                            \
    case 8:                                                                    \
...
// CTLZ libcall only supports 32/64/128-bit sizes.
#define RTLIBCASE_INT_CTLZ(LibcallPrefix)                                      \
  do {                                                                         \
    switch (Size) {                                                            \
    case 32:                                                                   \
      return RTLIB::LibcallPrefix##32;                                         \
...
#define RTLIBCASE(LibcallPrefix)                                               \
  ...
  case TargetOpcode::G_MUL:
    RTLIBCASE_INT_ARITH(MUL_I);
  case TargetOpcode::G_SDIV:
    RTLIBCASE_INT_ARITH(SDIV_I);
  case TargetOpcode::G_UDIV:
    RTLIBCASE_INT_ARITH(UDIV_I);
