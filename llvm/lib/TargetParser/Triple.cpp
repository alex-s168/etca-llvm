...
StringRef Triple::getArchTypeName(ArchType Kind) {
  ...
  case etca16:         return "etca16";
  case etca32:         return "etca32";
  case etca64:         return "etca64";
...
static Triple::ArchType parseArch(StringRef ArchName) {
  auto AT =
      StringSwitch<Triple::ArchType>(ArchName)
          ...
          .Case("etca16", Triple::etca16)
          .Case("etca32", Triple::etca32)
          .Case("etca64", Triple::etca64)
...
Triple Triple::get32BitArchVariant() const {
  ...
  case Triple::etca16:         T.setArch(Triple::etca32);  break;
  case Triple::etca64:         T.setArch(Triple::etca32);  break;
...
Triple Triple::get64BitArchVariant() const {
  ...
  case Triple::etca16:          T.setArch(Triple::etca64);     break;
  case Triple::etca32:          T.setArch(Triple::etca64);     break;
